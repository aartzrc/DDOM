            ...
            switch(mode) {
                ...
                case OfType(start):
                    switch(c) {
                        case "\\".code:
                            mode = Escape(mode);
                        case "[".code:
                            group.push(OfType(start == i ? "*" : selector.substring(start, i), filters));
                            mode = FieldFilter(i);
                        case ":".code:
                            group.push(OfType(start == i ? "*" : selector.substring(start, i), filters));
                            mode = PropFilter(i);
                        case "#".code:
                            ...
                            mode = IdFilter(i);
                        case " ".code:
                            if(i-start > 0) group.push(OfType(start == i ? "*" : selector.substring(start, i), filters));
                            mode = Descendants(i);
                            filters = [];
                        case ",".code:
                            group.push(OfType(start == i ? "*" : selector.substring(start, i), filters));
                ...
                case Descendants(start):
                    switch(c) {
                        ...
                        case "[".code:
                            ...
                            if(lastFilters == null) group.push(Descendants(t.length == 0 || t == "." ? "*" : t, filters));
                ...
                case Children(start):
                    switch(c) {
                        ...
                        case "[".code:
                            var t = selector.substring(start+1, i);
                            group.push(Children(t.length == 0 ? "*" : t, filters));
                            mode = FieldFilter(i);
                        case ":".code:
                            var t = selector.substring(start+1, i);
                            group.push(Children(t.length == 0 ? "*" : t, filters));
                ...
                case Parents(start):
                    switch(c) {
                        ...
                        case "[".code:
                            var t = selector.substring(start+1, i);
                            group.push(Parents(t.length == 0 ? "*" : t, filters));
                            mode = FieldFilter(i);
                        case ":".code:
                            var t = selector.substring(start+1, i);
                            group.push(Parents(t.length == 0 ? "*" : t, filters));
